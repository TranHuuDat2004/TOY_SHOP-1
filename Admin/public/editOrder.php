...
";
  $sql2 = "SELECT *
FROM `order` 
JOIN user ON `order`.u_id = user.u_id
    ...
    <aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
      <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <a href="index.html" class="ml-6 text-lg font-bold text-gray-800 dark:text-gray-200" href="#">
          <h1 class="m-0 text-primary1 "><span class="text-dark1"><img class="Imagealignment" src="/Fontend/images/icon.png">Omacha</h1>
        </a>
        ...
        <ul>
          <li class="relative px-6 py-3">
            <span class="" aria-hidden="true"></span>
            <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" href="manageUser.html">
              <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <li class="relative px-6 py-3">
            ...
            <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" href="addProduct.html">
          ...
          <li class="relative px-6 py-3">
            <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="ManageOrder.php">
              <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <aside class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white dark:bg-gray-800 md:hidden" x-show="isSideMenuOpen" x-transition:enter="transition ease-in-out duration-150" x-transition:enter-start="opacity-0 transform -translate-x-20" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in-out duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0 transform -translate-x-20" @click.away="closeSideMenu" @keydown.escape="closeSideMenu">
      <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul>
          ...
          <li class="relative px-6 py-3">
            <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
            <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" href="tables.html">
              <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                <path d="M4 6h16M4 10h16M4 14h16M4 18h16"></path>
              </svg>
    ...
    <div class="flex flex-col flex-1 w-full">
          ...
          <ul class="flex items-center flex-shrink-0 space-x-6">
            ...
            <li class="relative">
              <button class="align-middle rounded-full focus:shadow-outline-purple focus:outline-none" @click="toggleProfileMenu" @keydown.escape="closeProfileMenu" aria-label="Account" aria-haspopup="true">
                <img class="object-cover w-8 h-8 rounded-full" src="/Fontend/images/ThuyKhanh1.jpg" alt="" aria-hidden="true" />
              </button>
      ...
      <main class="h-full pb-16 overflow-y-auto">
        ...
        <form method="POST" enctype="multipart/form-data" action="updateOrder.php">
          <div class="content">
            <input type="hidden" name="o_id" value="<?php echo $row1['o_id']; ?>">
            ...
            <div class="form-group text-gray-700 dark:text-gray-200">
              ...
              <img src="../../Fontend/images/<?php echo $row1['p_image']; ?>" alt="">
            </div>

            <div class="form-group text-gray-700 dark:text-gray-200">
              <label for="name">User Phone</label>
              <p><?php echo $row2['uphone']; ?> </p>
            </div>
            ...
            <div class="form-group text-gray-700 dark:text-gray-200">
              ...
              <select id="status" class="form-control" name="o_status">
                ...
                <option value="0" <?php if ($row1['o_status'] == '0') echo 'selected'; ?>>0</option>
                <option value="1" <?php if ($row1['o_status'] == '1') echo 'selected'; ?>>1</option>
              </select>
            </div>
