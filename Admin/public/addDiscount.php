...
<?php
    ...
    if(isset($_POST['sbm'])) {
        ...
        $d_start_date= $_POST['d_start_date'];
        $d_end_date = $_POST['d_end_date'];
        ...
        //echo "Test3<br>";
        $sql = "INSERT INTO discount (d_name, d_amount, d_description, d_start_date, d_end_date) 
        VALUES ('$d_name', '$d_amount', '$d_description', '$d_start_date', '$d_end_date')"; //thay sua them thuoc tính date
        ...
        <form method="POST" enctype="multipart/form-data">
          <div class="content">
            <div class="form-group text-gray-700 dark:text-gray-200">
              <label for="name">Name Discount</label>
              <input class="form-control" name="d_name" id="name" type="text" placeholder="Name Discount">
            </div>

            <div class="form-group text-gray-700 dark:text-gray-200">
              <label for="price">Amount</label>
              <input class="form-control" id="name" name="d_amount" type="text" placeholder="Amount">
            </div>

            <div class="form-group text-gray-700 dark:text-gray-200">
              <label for="type">Description</label>
              <select id="type" class="form-control" name="d_description">
            ...
            <div class="form-group text-gray-700 dark:text-gray-200">
              ...
              <input class="form-control" id="name" name="d_start_date" type="date">
            </div>

            <div class="form-group text-gray-700 dark:text-gray-200">
              <label for="price">End Date</label>
              <input class="form-control" id="name" name="d_end_date" type="date">
            </div>
